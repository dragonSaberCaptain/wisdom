package com.jskj.wisdom.utils.database.redis;
...
/**
 * Copyright © 2017善林财富. All rights reserved.
 * <p>
 * redis缓存工具类
 * <br/>
 *
 * @author: dragonSaberCaptain
 * @date: 2017年12月15日 下午2:14:02
 */
 ...
 *
 * @author dragonSaberCaptain
 * @date: 2017年12月15日 下午3:14:13
 */
public class JedisUtil {
    /**
     * 默认范围的存储key
     */
    public static final String          SCOPE_KEY         = "sysKey";
    public static final String          ALL_KEY           = "all";
    /**
     * 默认ip地址和端口号的存储key
     */
    public static final String          HOST_AND_PORT_KEY = "hostAndPortKey";
    /**
     * 默认密码的存储key
     */
    ...
    public static final String          IS_CLUSTER_KEY    = "isClusterKey";
    /**
     * 默认hash存储前缀
     */
    ...
    public static Set<HostAndPort> getHostAndPort(String hostAndPorts) {
        ...
        for (String ipPort : hostAndPort) {
            ...
            nodes.add(new HostAndPort(String.valueOf(ipPortPair[0].trim()),
            ...
            if (jedisClusters != null) {
                ...
                if (map.size() != 0) {
                    ...
                    for (JedisPool jedisPool : map.values()) {
                        result = jedisPool.getResource().ping();
    ...
    public static class Lists {
         ...
         * @author dragonSaberCaptain
         */
        public static long linsert(byte[] key, LIST_POSITION where,
